...
public class Weibo {
    ...
    public boolean share2weibo(Activity activity, String accessToken, String tokenSecret,
        ...
        Intent i = new Intent(activity, SinaShareActivity.class);
        i.putExtra(SinaShareActivity.EXTRA_ACCESS_TOKEN, accessToken);
        i.putExtra(SinaShareActivity.EXTRA_TOKEN_SECRET, tokenSecret);
        i.putExtra(SinaShareActivity.EXTRA_WEIBO_CONTENT, content);
        i.putExtra(SinaShareActivity.EXTRA_PIC_URI, picPath);
